let url = "http://localhost:3000/kajal"
...
let loadData = async(kajal) => {
    ...
    try {
        let url = `http://localhost:3000/kajal?id=${id}`
                    ...
                    <div class="kajalCard">
                             ...
                             <div class="kajalCardRight">
                                        ...
                                        <div class= productRating>
                                            <img class="ratingImg" src="rating.png"></img><hr>
                                        ...
                                        <div class="authenticTags">
                                            ...
                                            <div><img src="exchange.png" width="27" alt="easy returns icon"></div>
